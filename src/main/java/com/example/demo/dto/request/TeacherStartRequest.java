...
public class TeacherStartRequest {
  ...
  private String teacherToken;         // required if source=qr
  ...
  public String getTeacherToken() { return teacherToken; }
  public void setTeacherToken(String teacherToken) { this.teacherToken = teacherToken; }
}
